function [input, output] = calControlSysID(uini, yini_noi, Tini, N, A, B, C, ...
                           D, Q, R, ry, ru, ulimit)
...
x(1:xdim, 1) = x0;
for i = 1:N
    Constraints = [Constraints, y((i-1)*ydim+1:i*ydim, 1)==C*x((i-1)*xdim+1:i*xdim, 1)+D*u((i-1)*udim+1:i*udim, 1),...
